...
public class MyUsernamePasswordAuthProvider
	...
	protected Body getVerifyEmailMailingBody(final String token,
		...
		final String html = getEmailTemplate(
				"views.html.account.signup.email.verify_email", "en", url,
				token, user.getName(), user.getEmail());
		final String text = getEmailTemplate(
				"views.txt.account.signup.email.verify_email", "en", url,
				token, user.getName(), user.getEmail());
	...
	protected Body getPasswordResetMailingBody(final String token,
		...
		final String html = getEmailTemplate(
				"views.html.account.email.password_reset", "en", url,
				token, user.name, user.email);
		final String text = getEmailTemplate(
				"views.txt.account.email.password_reset", "en", url, token,
	...
	protected Body getVerifyEmailMailingBodyAfterSignup(final String token,
		...
		final String html = getEmailTemplate(
				"views.html.account.email.verify_email", "en", url, token,
				user.name, user.email);
		final String text = getEmailTemplate(
				"views.txt.account.email.verify_email", "en", url, token,
				user.name, user.email);
